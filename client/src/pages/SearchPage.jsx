...
export default function SearchPage() {
    ...
    return (
        <div className="page-enter">
            {/* Search Header */}
            <div className="mb-8">
                <h1 className="text-2xl lg:text-3xl font-extrabold text-white mb-6">
                    <Search className="w-7 h-7 inline mr-3 text-[#8b5cf6]" />
                    Tìm Kiếm Phim
                </h1>
                ...
                <form onSubmit={handleSearch} className="max-w-2xl">
                    <div className="relative">
                        ...
                        <button
                            type="submit"
                            className="absolute right-2 top-1/2 -translate-y-1/2 btn-gradient py-2.5 px-6 rounded-xl text-sm"
                        >
                            Tìm kiếm
                        </button>
                    </div>
            ...
            {keyword && (
                <>
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-1 h-7 rounded-full bg-gradient-to-b from-[#e50914] to-[#8b5cf6]" />
                        <h2 className="text-lg font-bold text-white">
                            Kết quả cho "{keyword}"
                        </h2>
                        {pagination.totalItems && (
                            <span className="text-xs text-[#6b6b80] bg-white/5 px-2.5 py-1 rounded-full">
